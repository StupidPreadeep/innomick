...
export default createReducer(initialState, {
  ...
  [AUTH_CONST.REGISTER_SUCCESS]: (state, payload) => {
    return Object.assign({}, state, {
      "isRegisterAuthenticating": false,
      "isRegisterAuthenticated": true,
  ...
  [AUTH_CONST.TOKEN_SUCCESS]: (state, payload) => {
    return Object.assign({}, state, {
      token_verified: payload,
    });
  },
  ...
  [AUTH_CONST.REGISTER_RESET]: (state, payload) => {
    return Object.assign({}, state, {
      "isRegisterAuthenticating": false,
      "isRegisterAuthenticated": false,
      "statusText": null,
  ...
  [AUTH_CONST.LOGIN_REQUEST_RESET]: (state, payload) => {
    return Object.assign({}, state, {
      "isAuthenticating": false,
  ...
  [AUTH_CONST.FORGOT_PASSWORD_FAILURE]: (state, payload) => {
    ...
    return Object.assign({}, state, {
      "isAuthenticating": false,
      "isAuthenticated": false,
      "statusText": (payload && payload.error && payload.error.statusText) ? payload.error.statusText : "Something went wrong. Please try again later.",
    });
  },
