...
export const GET_MASTER_TABLES_DATA = `${process.env.REACT_APP_SERVER_URL}/HC_Patient/api/MasterData/MasterDataByName`; // GET - /quoteData?symbol=AAPL&field=4+10+11
